...
async function seed() {
  ...
  const patientsData = [
    ...
    },
    {
      ...
      visits: [
        ...
        { date: new Date('2026-05-30'), ga: 26, sbp: 130, dbp: 84, proteinuria: 'None', weight: 64, recordedBy: nurse._id, recordedAt: new Date('2026-05-30') },
        { date: new Date('2026-06-05'), ga: 30, sbp: 136, dbp: 88, proteinuria: 'Trace', weight: 65, recordedBy: nurse._id, recordedAt: new Date('2026-06-05') },
      ],
    },
  ]
  ...
  console.log('\n Seed complete!')
  console.log(' Login: a.uwase@bugesera.rw')
